...
from nnunetv2.architectures.operations.global_pooling import GlobalAvgPool3d, GlobalAvgPool2d
from nnunetv2.architectures.unet_extensions import ResEncUNetAuxTask
...
class ResEncUNetAuxTaskPlanner(ResEncUNetPlanner):
    ...
    def get_plans_for_configuration(self,
        ...
        pool = GlobalAvgPool3d if is_3d else GlobalAvgPool2d
        norm = nn.LayerNorm
        ...
        plan['architecture']['arch_kwargs'].update({
            ...
            'aux_pool_op_kwargs': None,
            'aux_norm_op':  norm.__module__ + '.' + norm.__name__,
            'aux_norm_op_kwargs': {'eps': 1e-5},
            'aux_dropout_op': dropout.__module__ + '.' + dropout.__name__,
